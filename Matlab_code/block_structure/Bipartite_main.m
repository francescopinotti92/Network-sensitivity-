...
Group1 = randsample(1:num_bank, NbanksGroup1);
Allbanks = 1:num_bank;
...
if single_bank_flag == false
    ...
    p = boxplot(plot_data');
    xlabel('\beta')
    xticklabels(num2str(lambdavec'));
    ylabel('average equity loss Second Layer')
    save('Bipartite_fig4_SingleBank.mat', 'plotData', 'lambdavec');
end
